...
public class DisplayInserirPaciente extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.adicionar_paciente, container, false);
    }
    ...
    public void cancelar() {
        NavController navController = NavHostFragment.findNavController(DisplayInserirPaciente.this);
